...
namespace API.Controllers
{
    ...
    public class AccountController:ControllerBase
    {
        ...
        private string GenerateToken(AppUser user)
        {
            ...
            var securityKey = _configuration.GetSection("JWTSetting").GetSection("securityKey").Value;
            ...
            Console.WriteLine($"Valid Audience: {validAudience}");
            Console.WriteLine($"Valid Issuer: {validIssuer}");


            if (string.IsNullOrEmpty(securityKey) || string.IsNullOrEmpty(validAudience) || string.IsNullOrEmpty(validIssuer))
            {
                throw new ArgumentNullException("JWTSetting", "One or more JWT settings are missing in the configuration.");
            }
